...
<s:set var="iconImagePath" var="iconImagePath"><wp:ResourceURL ignoreTenant="true"/>administration/common/img/icons/go-up.png</s:set>
...
<s:set var="iconImagePath" var="iconImagePath"><wp:ResourceURL ignoreTenant="true"/>administration/common/img/icons/go-down.png</s:set>
<wpsf:submit useTabindexAutoIncrement="true" action="%{#actionName}" type="image" src="%{#iconImagePath}"
...
<s:set var="iconImagePath" var="iconImagePath"><wp:ResourceURL ignoreTenant="true"/>administration/common/img/icons/list-remove.png</s:set>
<wpsf:submit useTabindexAutoIncrement="true" action="%{#actionName}" type="image" src="%{#iconImagePath}"
	value="%{label_remove}"
	title="%{label_remove}" />